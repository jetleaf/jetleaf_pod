...
abstract interface class AutowirePodFactory implements PodFactory {
  ...
  /// methods or InitializingPod interfaces.
  ///
  /// ## Usage Example:
  /// ```dart
...
/// {@endtemplate}
abstract interface class ConfigurablePodFactory implements HierarchicalPodFactory, ApplicationStartupAware, SingletonPodRegistry, AliasRegistry {
  ...
  /// ## Usage Example:
  /// ```dart
  /// factory.setAllowRawInjection(true); // Allow raw injection
  /// ```
  ///
  ...
  /// ## Usage Example:
  /// ```dart
  /// final count = factory.getPodProcessorCount();
  ...
  /// ## Usage Example:
  /// ```dart
  /// final processors = factory.getPodProcessors();
  ...
  /// ## Usage Example:
  /// ```dart
  /// factory.addPodProcessor(MyCustomPodProcessor());
  /// ```
  ///
  ...
  /// ## Usage Example:
  /// ```dart
  /// final allowRawInjection = factory.getAllowRawInjection();
